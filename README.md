...
<li>Due to network conditions in China, native writing is avoided; instead, aria2 is used for downloading, to monitor the progress.</li>
</ol>
...
<p>Powershell one-click IDM activation (<a href="#">my own solution is outdated, no updates due to copyright issues in China</a>)</p>
